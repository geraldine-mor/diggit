...
|  | A user cannot like the same comment more than once | Liked a comment, then tried to like it again | Second like toggles the like off, count does not increment | ⚠️ | ![screenshot](documentation/defensive) |
